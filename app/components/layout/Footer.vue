...
<template>
	<footer
		class="container flex flex-col gap-4 bg-surface text-on-surface border border-surface-border rounded-3xl px-8 py-6"
	>
		...
		<div>
			<p>
				Nous nous efforçons de fournir un site web ergonomique et
				accessible à tous. Si vous rencontrez des difficultés, n'hésitez
